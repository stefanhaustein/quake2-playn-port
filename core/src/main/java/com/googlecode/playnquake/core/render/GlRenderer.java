...
public class GlRenderer implements Renderer {
  ...
  // ============================================================================
  /**
   * @see com.googlecode.playnquake.core.client.Renderer#Init()
   */
  ...
  /**
   * @see com.googlecode.playnquake.core.client.Renderer#Shutdown()
   */
  ...
  /**
   * @see com.googlecode.playnquake.core.client.Renderer#BeginRegistration(java.lang.String)
   */
  ...
  /**
   * @see com.googlecode.playnquake.core.client.Renderer#RegisterModel(java.lang.String)
   */
  ...
  /**
   * @see com.googlecode.playnquake.core.client.Renderer#RegisterSkin(java.lang.String)
   */
  ...
  /**
   * @see com.googlecode.playnquake.core.client.Renderer#RegisterPic(java.lang.String)
   */
  ...
  /**
   * @see com.googlecode.playnquake.core.client.Renderer#SetSky(java.lang.String,
   *      float, float[])
   */
  ...
  /**
   * @see com.googlecode.playnquake.core.client.Renderer#EndRegistration()
   */
  ...
  /**
   * @see com.googlecode.playnquake.core.client.Renderer#RenderFrame(com.googlecode.playnquake.core.client.RendererState)
   */
...
//      }
  ...
  public void uploadImage(Image image) {
    ...
    if (image.type == com.googlecode.playnquake.core.common.QuakeImage.it_pic) {
      ...
      PlayN.graphics().ctx().texImage2D(image.playNImage,  GL20.GL_TEXTURE_2D, 0, GL20.GL_RGBA, GL20.GL_RGBA, GL20.GL_UNSIGNED_BYTE);
      ...
      if (Images.skyTarget.upload_width != 6 * image.width) {
    	  PlayN.graphics().ctx().texImage2D(PlayN.graphics().createImage(6 * image.width, image.height), GL20.GL_TEXTURE_2D, 0, GL20.GL_RGBA, GL20.GL_RGBA, GL20.GL_UNSIGNED_BYTE);
        Images.skyTarget.upload_width = 6 * image.width;
      }
      Images.skyTarget.upload_height = image.height;
      PlayN.graphics().ctx().texSubImage2D(image.playNImage,  GL20.GL_TEXTURE_2D, 0, image.width * image.skyIndex, 0, GL20.GL_RGBA, GL20.GL_UNSIGNED_BYTE);
    } else {
      ...
      do {
        ...
        PlayN.graphics().ctx().texImage2D(canvasImage,  GL20.GL_TEXTURE_2D, level++, GL20.GL_RGBA, GL20.GL_RGBA, GL20.GL_UNSIGNED_BYTE);
        p2size /= 2;
      }
      while(p2size > 0);
    }

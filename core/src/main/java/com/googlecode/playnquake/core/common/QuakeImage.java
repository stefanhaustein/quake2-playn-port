...
//					+ '\n');
	...
	//		int length;
			...
			if (targa_header.image_type != 2 && targa_header.image_type != 10) 
				throw new RuntimeException("LoadTGA: Only type 2 and 10 targa RGB images supported\n");
			
			if (targa_header.colormap_type != 0 || (targa_header.pixel_size != 32 && targa_header.pixel_size != 24))
				throw new RuntimeException ("LoadTGA: Only 32 or 24 bit images supported (no colormaps)\n");

...
function resolveToFullPath_(cwdFullPath, path) {
  ...
  console.log("resolveFullPath", cwdFullPath, path, fullPath);
...
DirectoryEntry.prototype.getDirectory = function(path, options, successCallback,
  ...
  console.log(this.fullPath, ".getDirectory", path, options);
...
DirectoryEntry.prototype.getFile = function(path, options, successCallback,
  ...
  window.console.log("getFile", path, options);
  ...
  idb_.get(path, function(fileEntry) {
    ...
    window.console.log("getFile2", path, options, fileEntry);
